...
logger.info(f"📱 TELEGRAM_TOKEN: {'***' if TELEGRAM_TOKEN else 'NOT SET'}")
...
async def health_server():
    """Minimální HTTP server pro Cloud Run health check."""
...
async def main():
    logger.info("🚀 Starting dispatcher polling...")
...
if __name__ == "__main__":
    logger.info("📡 aiogram_bot.py is running...")
    asyncio.run(main())